...
function wellnez_pagination( $args = array() ) {
    $allowhtml = array(
    	'p'         => array(
    		'class'     => array()
    	),
    ...
    $defaults = array(
        'range'           => 4,
        'custom_query'    => FALSE,
        'previous_string' => esc_html__( '&laquo;', 'wellnez' ),
        'next_string'     => esc_html__( '&raquo;', 'wellnez' ),
        'before_output'   => '',
        'after_output'    => ''
    );
    ...
    $args = wp_parse_args(
        $args,
        apply_filters( 'wellnez_pagination_defaults', $defaults )
    );
