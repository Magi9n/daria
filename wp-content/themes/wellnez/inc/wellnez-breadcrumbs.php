...
if ( ! function_exists( 'wellnez_breadcrumbs' ) ) {
    function wellnez_breadcrumbs( $args = array() ) {
        if ( is_front_page() ) {
            return;
        }
        ...
        $defaults  = array(
            ...
            'home_title'          => esc_html__( 'Home', 'wellnez' )
        );
        $args    = apply_filters( 'wellnez_breadcrumbs_args', wp_parse_args( $args, $defaults ) );
        ...
        */
        ...
        $html = '';
        $html .= '<ul class="breadcumb-menu text-white pt-1" '.implode( ' ',  $args_el ).'>';
        ...
        if ( is_singular( 'post' ) ) {
            ...
            $html .= '<li class="active bread-search">'.esc_html__('Search results for: ','wellnez') . get_search_query() . '</li>';
        } elseif ( is_404() ) {
            $html .= '<li>' . esc_html__( 'Error 404', 'wellnez' ) . '</li>';
        } elseif ( is_home() ) {
        ...
        if( class_exists('woocommerce') ) {
            ...
            echo apply_filters( 'wellnez_breadcrumbs_filter', $html );
        }
