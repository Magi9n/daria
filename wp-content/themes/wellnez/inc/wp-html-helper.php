...
// image default alt
if( !function_exists( 'wellnez_img_default_alt' ) ){
	function wellnez_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'wellnez_img_tag' ) ){
	function wellnez_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = wellnez_img_default_alt( $url );
		}
...
// Anchor Tag
if( !function_exists( 'wellnez_anchor_tag' ) ){
	function wellnez_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'wellnez_heading_tag' ) ){
	function wellnez_heading_tag( array $args ){
...
// Paragraph Tag
if( !function_exists( 'wellnez_paragraph_tag' ) ){
	function wellnez_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'wellnez_span_tag' ) ){
	function wellnez_span_tag( array $args ){
