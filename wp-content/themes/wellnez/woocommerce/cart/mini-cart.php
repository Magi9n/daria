...
<?php if ( ! empty( WC()->cart ) ) : ?>
				...
				<li class="woocommerce-mini-cart-item mini_cart_item remove-item <?php echo esc_attr( apply_filters( 'woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key ) ); ?>">
					...
					echo apply_filters( // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
						...
						sprintf(
							...
							esc_attr__( 'Remove this item', 'wellnez' ),
							esc_attr( $product_id ),
    ...
    <p class="woocommerce-mini-cart__total total">
        <strong><?php echo esc_html__('Subtotal','wellnez'); ?></strong>
...
<?php else : ?>
    ...
    <div class="empty_cart text-center">
        <?php
            ...
            echo '<h3 class="pt-5">'.esc_html__('Your cart is currently empty.','wellnez').'</h3>';
        ?>
    </div>
